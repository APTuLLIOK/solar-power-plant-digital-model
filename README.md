...
### 1. Наложение расчетной модели на фактические данные (Test)
...
### 2. Анализ распределения остатков (Residuals)
...
**Вывод:** Систематические ошибки в модели отсутствуют. Любые резкие выбросы из этого распределения в продакшене будут однозначно сигнализировать о физической поломке оборудования или ошибках датчиков телеметрии.
